...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="#home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      <motion.div
       className="mx-auto  w-5/6 item-center justify-center md:flex md:h-5/6 "
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className="relative">
              <div className="before:absolute before:-top-20 mt-32 before:-left-20 before:z-[-1] md:before:content-evolvetext">
                <img alt="home-page-txr" src={HomePageText} />
              </div>
            </div>
